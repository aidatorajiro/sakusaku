...
// Reset every variable to the initial value
reset_all: function () {
    app.vowel = ""
    app.consonant = ""
    app.letters = []
...
// start dictionary lookup for current position
...
// called after all consonants are consumed
...
// called after user clicks the button
